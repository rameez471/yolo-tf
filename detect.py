...
class YOLO(object):
    ...
    def load_yolo_model(self):
        ...
        assert model_path.endswith('.h5'),'Model or weight must be a .h5 file'
        ...
        try:
            ...
            assert self.yolo_model.layers[-1].output_shape[-1] == \
                    num_anchors / len(self.yolo_model.output) * (num_classes + 5), 'Missmatch between model and given anchor and class type'
